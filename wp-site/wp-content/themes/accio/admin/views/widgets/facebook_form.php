...
<p>
    <label for="<?php echo $widget->get_field_id('pageID'); ?>"><?php _e('Facebook Page ID', 'accio') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('connection'); ?>"><?php _e('People to show', 'accio') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('height'); ?>"><?php _e('Box height', 'accio') ?>:</label>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('header'); ?>"><?php _e('Header', 'accio') ?></label>
</p>
