...
<div class="slide-item" id="slide_item_<?php echo $unique_id ?>">
    ...
    <div class="slide-thumb">
		...
		<a href="#" class="button js_edit_slide" data-slide-id="<?php echo $unique_id ?>"><?php _e('Edit Image', 'accio'); ?></a>
	</div>

    <a href="#" class="js_delete_slide" slide-id="<?php echo $unique_id ?>" title="<?php _e('Delete Slide', 'accio'); ?>"><?php _e('Delete Slide', 'accio'); ?></a>
