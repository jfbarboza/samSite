...
<p>
    <label for="<?php echo $widget->get_field_id('category'); ?>"><?php _e('Posts Category', 'accio') ?>:</label>
	<?php
	$args = array(
		'hide_empty' => 0,
		'show_option_all' => __('All Categories', 'accio'),
		'echo' => 0,
...
<p>
    <label for="<?php echo $widget->get_field_id('post_count'); ?>"><?php _e('Count', 'accio') ?>:</label>
    <input class="widefat" type="text" id="<?php echo $widget->get_field_id('post_count'); ?>" name="<?php echo $widget->get_field_name('post_count'); ?>" value="<?php echo $instance['post_count']; ?>" />
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_thumbnail'); ?>"><?php _e('Display Thumbnail', 'accio') ?>:</label>
</p>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_exerpt'); ?>"><?php _e('Display Excerpt', 'accio') ?></label>
</p>


<p>
    <label for="<?php echo $widget->get_field_id('exerpt_symbols_count'); ?>"><?php _e('Excerpt symbols count', 'accio') ?>:</label>
...
<p>
    ...
    <label for="<?php echo $widget->get_field_id('show_see_all_button'); ?>"><?php _e('Display "See all Posts" button', 'accio') ?></label>
</p>
